...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .print-btn { display: block; margin: 24px auto; background: #166534; color: white; border: none; padding: 12px 32px; border-radius: 8px; font-size: 15px; font-weight: 600; cursor: pointer; }
    @media print { .print-btn { display: none; } body { padding: 0; background: white; } .container { box-shadow: none; } }
  </style>
</head>
<body>
  <div class="container">
    ...
    <div class="section">
      ...
      <div class="info-grid">
        <div class="info-item"><label>Nome</label><span>Márcio Maciel</span></div>
        ...
        <div class="info-item"><label>Referência da Fatura</label><span>Fevereiro/2026</span></div>
        <div class="info-item"><label>Bandeira Tarifária</label><span>Verde</span></div>
      </div>
    </div>
    ...
    <div class="section">
      ...
      <div class="info-grid">
        <div class="info-item"><label>Consumo médio (12 meses)</label><span>${mediaConsumo.toFixed(0)} kWh/mês</span></div>
    ...
    <div class="section">
      <div class="section-title">Histórico de Consumo — Mês a Mês</div>
      <table>
        <thead>
          <tr>
            <th>Mês</th>
    ...
    <div class="footer">
      ...
      <p>Proposta válida por 30 dias. Valores sujeitos a reajuste tarifário da concessionária.</p>
    </div>
  </div>
...
const outputPath = './proposta-marcio-maciel.html';
fs.writeFileSync(outputPath, html, 'utf8');
console.log(`✅ Proposta gerada: ${outputPath}`);
