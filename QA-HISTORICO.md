...
## Bugs P2 atualmente abertos (17/04/2026)
...
| **BUG-NEW-2026-04-17-001** | **confirmar-nova-uc: proposta com 300kWh fictícios quando sem fatura prévia** | **Urgente** |
| **BUG-NEW-2026-04-17-002** | **novaUcComFatura: UC criada sem rollback se motor de proposta falhar** | **Próximo** |
| **BUG-NEW-2026-04-17-003** | **DocumentosAprovacaoJob: aprova automaticamente sem verificar revisão humana** | **Urgente** |
| **BUG-NEW-2026-04-17-004** | **cadastroWebV2: outlier silencioso — propostaId=null sem feedback ao usuário** | **Próximo** |
| **BUG-NEW-2026-04-15-001** | **contas-pagar: sem class-validator DTOs, entrada não validada (valor negativo, data inválida)** | **Próximo** |
| **BUG-NEW-2026-04-15-002** | **contas-pagar: SUPER_ADMIN expõe dados inter-tenant (info leak findAll sem cooperativaId)** | **Próximo** |
...
| BUG-NEW-2026-04-11-003 | BONUS_INDICACAO idempotência sem cooperativaId | Próximo |
...
*Última atualização: 17/04/2026 às 03:00 | Próxima: 18/04/2026 às 03h*
